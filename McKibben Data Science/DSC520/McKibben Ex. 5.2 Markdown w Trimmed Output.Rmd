...
# Splitting the data 
head(select(housing, c(Sale.Price, square_feet_total_living, sq_ft_lot))) 

# Organizing the data
head(arrange(housing, desc(square_feet_total_living), 
        .by_group = TRUE, .locale = "en"))
head(arrange(housing, desc(sq_ft_lot), .by_group = TRUE, .locale = "en"))
...
head(cbind(sale_price, sq_footage_interior))
