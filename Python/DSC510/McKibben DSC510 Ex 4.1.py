...
# Define main
def main(num_feet_cable):
    # Call logic based functions which perform calculations
    # Calculates cost of material from number of feet of cable
    ...
    # Calculate cost of labor from number of feet of material
    if num_feet_cable <= 100:
        cost_of_labor = 150
        pass
    ...
    print(cost_of_materials, cost_of_labor)
    return cost_of_materials, cost_of_labor

    if __name__ == "__main__":
        main(num_feet_cable)

output_array = main(num_feet_cable)
cost_of_materials = output_array[0]
cost_of_labor = output_array[1]

# Call function that calculates total cost
import total_cost_calc
total_cost = total_cost_calc.total_cost_calculator(cost_of_materials, cost_of_labor)
